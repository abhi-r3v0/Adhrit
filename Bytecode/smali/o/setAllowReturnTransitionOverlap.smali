...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lo/setAllowReturnTransitionOverlap$onMessageChannelReady;,
        Lo/setAllowReturnTransitionOverlap$extraCallback;
    }
.end annotation
...
.annotation runtime Lo/createEvent;
    ...
    d2 = {
        "Lcom/dreamplug/fabrik/ui/cm/CardMonthSwitcherDialog;",
        "Lcom/dreamplug/androidapp/ui/widget/CredBottomSheetDialog;",
        "()V",
        "adapter",
        "Lcom/dreamplug/utils/list/VerticalAdapter;",
        "extra",
        "Lcom/dreamplug/fabrik/ui/cm/CardMonthSwitcherDialog$Extra;",
        "getExtra",
        "()Lcom/dreamplug/fabrik/ui/cm/CardMonthSwitcherDialog$Extra;",
        "extra$delegate",
        "Lkotlin/Lazy;",
...
# static fields
.field public static final onPostMessage:Lo/setAllowReturnTransitionOverlap$extraCallback;
...
.field private extraCallback:Lo/onDisconnectSetValue;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lo/setAllowReturnTransitionOverlap$extraCallback;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lo/setAllowReturnTransitionOverlap$extraCallback;-><init>(B)V

    sput-object v0, Lo/setAllowReturnTransitionOverlap;->onPostMessage:Lo/setAllowReturnTransitionOverlap$extraCallback;
...
.method public constructor <init>()V
    ...
    .line 28
    new-instance v0, Lo/setAllowReturnTransitionOverlap$onPostMessage;

    invoke-direct {v0, p0}, Lo/setAllowReturnTransitionOverlap$onPostMessage;-><init>(Lo/setAllowReturnTransitionOverlap;)V
    ...
    .line 28
    iput-object v2, p0, Lo/setAllowReturnTransitionOverlap;->ICustomTabsCallback:Lo/isSameListener;

    .line 30
    sget-object v0, Lo/setAllowReturnTransitionOverlap$ICustomTabsCallback;->onMessageChannelReady:Lo/setAllowReturnTransitionOverlap$ICustomTabsCallback;
    ...
    .line 30
    iput-object v1, p0, Lo/setAllowReturnTransitionOverlap;->onMessageChannelReady:Lo/isSameListener;

    .line 65
    new-instance v0, Lo/setAllowReturnTransitionOverlap$onNavigationEvent;

    invoke-direct {v0, p0}, Lo/setAllowReturnTransitionOverlap$onNavigationEvent;-><init>(Lo/setAllowReturnTransitionOverlap;)V

    check-cast v0, Lo/hasGapsToFix$onMessageChannelReady;

    iput-object v0, p0, Lo/setAllowReturnTransitionOverlap;->onTransact:Lo/hasGapsToFix$onMessageChannelReady;

    return-void
.end method

.method public static final synthetic onMessageChannelReady(Lo/setAllowReturnTransitionOverlap;)Lo/getDimensionPixelOffset;
    .locals 0

    .line 10000
    iget-object p0, p0, Lo/setAllowReturnTransitionOverlap;->onMessageChannelReady:Lo/isSameListener;
...
.method public static final synthetic onNavigationEvent(Lo/setAllowReturnTransitionOverlap;)Lo/onDisconnectSetValue;
    .locals 0

    .line 25
    iget-object p0, p0, Lo/setAllowReturnTransitionOverlap;->extraCallback:Lo/onDisconnectSetValue;

    return-object p0
.end method

.method public static final synthetic onNavigationEvent(Lo/setAllowReturnTransitionOverlap;Lo/onDisconnectSetValue;)V
    .locals 0

    .line 25
    iput-object p1, p0, Lo/setAllowReturnTransitionOverlap;->extraCallback:Lo/onDisconnectSetValue;
...
.method public final ICustomTabsCallback(I)Landroid/view/View;
    ...
    iget-object v0, p0, Lo/setAllowReturnTransitionOverlap;->asInterface:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lo/setAllowReturnTransitionOverlap;->asInterface:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lo/setAllowReturnTransitionOverlap;->asInterface:Ljava/util/HashMap;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lo/setAllowReturnTransitionOverlap;->onTransact:Lo/hasGapsToFix$onMessageChannelReady;
    ...
    .line 38
    iput-object v0, p0, Lo/setAllowReturnTransitionOverlap;->onNavigationEvent:Lo/repositionToWrapContentIfNecessary;
...
.method public final onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 2000
    iget-object p2, p0, Lo/setAllowReturnTransitionOverlap;->ICustomTabsCallback:Lo/isSameListener;

    invoke-interface {p2}, Lo/isSameListener;->onNavigationEvent()Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lo/setAllowReturnTransitionOverlap$onMessageChannelReady;

    if-eqz p2, :cond_4

    .line 2076
    iget-object p2, p2, Lo/setAllowReturnTransitionOverlap$onMessageChannelReady;->onPostMessage:Lcom/dreamplug/fabrik/ui/cm/models/MyCardsResponse;
    ...
    .line 5000
    iget-object v1, p0, Lo/setAllowReturnTransitionOverlap;->ICustomTabsCallback:Lo/isSameListener;

    invoke-interface {v1}, Lo/isSameListener;->onNavigationEvent()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lo/setAllowReturnTransitionOverlap$onMessageChannelReady;
    ...
    .line 5076
    iget-object v1, v1, Lo/setAllowReturnTransitionOverlap$onMessageChannelReady;->onNavigationEvent:Ljava/lang/String;
    ...
    .line 6027
    :goto_1
    iget-object v8, v2, Lcom/dreamplug/fabrik/ui/cm/models/Template;->ICustomTabsCallback:Lcom/dreamplug/fabrik/ui/cm/models/TemplateProperties;

    .line 6088
    iget-object v8, v8, Lcom/dreamplug/fabrik/ui/cm/models/TemplateProperties;->extraCommand:Lcom/dreamplug/fabrik/ui/control/CardDetails;

    if-eqz v8, :cond_3

    .line 54
    invoke-virtual {v8}, Lcom/dreamplug/fabrik/ui/control/CardDetails;->getContext()Ljava/lang/String;
    ...
    .line 59
    :cond_4
    iget-object p2, p0, Lo/setAllowReturnTransitionOverlap;->onNavigationEvent:Lo/repositionToWrapContentIfNecessary;
