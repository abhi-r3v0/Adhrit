.class public final Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;
...
# instance fields
.field public final synthetic extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;

.field public final synthetic onMessageChannelReady:Landroid/animation/ObjectAnimator;


# direct methods
.method constructor <init>(Landroid/animation/ObjectAnimator;Lo/computeScrollExtent$ICustomTabsCallback$Stub;)V
    .locals 0

    iput-object p1, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->onMessageChannelReady:Landroid/animation/ObjectAnimator;

    iput-object p2, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;
...
.method public final onAnimationEnd(Landroid/animation/Animator;)V
    ...
    .line 458
    iget-object p1, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;
    ...
    .line 459
    iget-object v4, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;
    ...
    .line 460
    iget-object v3, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;
    ...
    .line 468
    iget-object v7, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;
    ...
    .line 474
    :goto_1
    iget-object v1, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->onMessageChannelReady:Landroid/animation/ObjectAnimator;

    invoke-virtual {v1}, Landroid/animation/ObjectAnimator;->start()V

    .line 479
    iget-object v1, p0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;->extraCallback:Lo/computeScrollExtent$ICustomTabsCallback$Stub;
    ...
    new-instance v1, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady$3;

    invoke-direct {v1, p0}, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady$3;-><init>(Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;)V
    ...
    .line 519
    new-instance v1, Lcom/dreamplug/fabrik/ui/lifestyle/MachinePullInternalFragment$stateChange$1$$special$$inlined$executeOnResume$lambda$1$2;

    invoke-direct {v1, p1, v0, p0}, Lcom/dreamplug/fabrik/ui/lifestyle/MachinePullInternalFragment$stateChange$1$$special$$inlined$executeOnResume$lambda$1$2;-><init>(Lo/MediaControllerCompatApi21$CallbackProxy;Lo/toDebugString$onMessageChannelReady;Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady;)V
    ...
    :cond_6
    :goto_2
    new-instance v0, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady$1;

    invoke-direct {v0, v2, p1}, Lo/computeScrollExtent$ICustomTabsCallback$Stub$onMessageChannelReady$1;-><init>(Lo/toDebugString$ICustomTabsCallback;Lo/MediaControllerCompatApi21$CallbackProxy;)V
