.class public final Lo/setSelection;
...
.method public constructor <init>(Lo/writeStringNoTag;Lo/DataTransportCrashlyticsReportSender;Lo/CachedSettingsIo;)V
    ...
    .line 39
    iput-object p1, p0, Lo/setSelection;->extraCallback:Lo/writeStringNoTag;

    .line 40
    iput-object p2, p0, Lo/setSelection;->onMessageChannelReady:Lo/DataTransportCrashlyticsReportSender;

    .line 41
    iput-object p3, p0, Lo/setSelection;->onPostMessage:Lo/CachedSettingsIo;
...
.method public final read(Lo/checkNoSpaceLeft;)Ljava/lang/Object;
    ...
    :cond_0
    new-instance v0, Lcom/cred/pay/repository/models/SimResponse;

    invoke-direct {v0}, Lcom/cred/pay/repository/models/SimResponse;-><init>()V

    iget-object v1, p0, Lo/setSelection;->extraCallback:Lo/writeStringNoTag;

    iget-object v3, p0, Lo/setSelection;->onMessageChannelReady:Lo/DataTransportCrashlyticsReportSender;
    ...
    .line 4000
    new-instance v4, Lo/onKeyPreIme;

    invoke-direct {v4}, Lo/onKeyPreIme;-><init>()V
    ...
    iput-object v4, v0, Lcom/cred/pay/repository/models/SimResponse;->onMessageChannelReady:Ljava/util/List;

    goto :goto_0

    :cond_3
    iput-object v2, v0, Lcom/cred/pay/repository/models/SimResponse;->onMessageChannelReady:Ljava/util/List;
    ...
    iput-object v4, v0, Lcom/cred/pay/repository/models/SimResponse;->onNavigationEvent:Ljava/lang/String;

    goto :goto_0

    :cond_5
    iput-object v2, v0, Lcom/cred/pay/repository/models/SimResponse;->onNavigationEvent:Ljava/lang/String;
...
.method public final write(Lo/computeTagSize;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lo/setSelection;->extraCallback:Lo/writeStringNoTag;

    iget-object v1, p0, Lo/setSelection;->onPostMessage:Lo/CachedSettingsIo;

    .line 1000
    invoke-virtual {p1}, Lo/computeTagSize;->onNavigationEvent()Lo/computeTagSize;

    .line 2000
    iget-object v2, p2, Lcom/cred/pay/repository/models/SimResponse;->onMessageChannelReady:Ljava/util/List;
    ...
    new-instance v2, Lo/onKeyPreIme;

    invoke-direct {v2}, Lo/onKeyPreIme;-><init>()V

    iget-object v3, p2, Lcom/cred/pay/repository/models/SimResponse;->onMessageChannelReady:Ljava/util/List;
    ...
    :cond_1
    iget-object v2, p2, Lcom/cred/pay/repository/models/SimResponse;->onNavigationEvent:Ljava/lang/String;
