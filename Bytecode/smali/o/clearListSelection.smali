.class public final Lo/clearListSelection;
...
.method public constructor <init>(Lo/writeStringNoTag;Lo/DataTransportCrashlyticsReportSender;Lo/CachedSettingsIo;)V
    ...
    .line 39
    iput-object p1, p0, Lo/clearListSelection;->onMessageChannelReady:Lo/writeStringNoTag;

    .line 40
    iput-object p2, p0, Lo/clearListSelection;->extraCallback:Lo/DataTransportCrashlyticsReportSender;

    .line 41
    iput-object p3, p0, Lo/clearListSelection;->onPostMessage:Lo/CachedSettingsIo;
...
.method public final read(Lo/checkNoSpaceLeft;)Ljava/lang/Object;
    ...
    :cond_0
    new-instance v0, Lcom/cred/pay/repository/models/SimDetail;

    invoke-direct {v0}, Lcom/cred/pay/repository/models/SimDetail;-><init>()V

    iget-object v1, p0, Lo/clearListSelection;->onMessageChannelReady:Lo/writeStringNoTag;

    iget-object v3, p0, Lo/clearListSelection;->extraCallback:Lo/DataTransportCrashlyticsReportSender;
    ...
    iput-object v4, v0, Lcom/cred/pay/repository/models/SimDetail;->extraCallback:Ljava/lang/String;

    goto :goto_0

    :cond_3
    iput-object v2, v0, Lcom/cred/pay/repository/models/SimDetail;->extraCallback:Ljava/lang/String;
    ...
    iput-object v4, v0, Lcom/cred/pay/repository/models/SimDetail;->onNavigationEvent:Ljava/lang/String;

    goto :goto_0

    :cond_5
    iput-object v2, v0, Lcom/cred/pay/repository/models/SimDetail;->onNavigationEvent:Ljava/lang/String;
...
.method public final write(Lo/computeTagSize;Ljava/lang/Object;)V
    ...
    :cond_0
    check-cast p2, Lcom/cred/pay/repository/models/SimDetail;

    iget-object v0, p0, Lo/clearListSelection;->onMessageChannelReady:Lo/writeStringNoTag;

    iget-object v1, p0, Lo/clearListSelection;->onPostMessage:Lo/CachedSettingsIo;

    .line 1000
    invoke-virtual {p1}, Lo/computeTagSize;->onNavigationEvent()Lo/computeTagSize;

    .line 2000
    iget-object v2, p2, Lcom/cred/pay/repository/models/SimDetail;->onNavigationEvent:Ljava/lang/String;
    ...
    iget-object v3, p2, Lcom/cred/pay/repository/models/SimDetail;->onNavigationEvent:Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, p2, Lcom/cred/pay/repository/models/SimDetail;->extraCallback:Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/cred/pay/repository/models/SimDetail;->extraCallback:Ljava/lang/String;
