.class public final Lo/performItemClick;
...
.field private onPostMessage:Lo/DataTransportCrashlyticsReportSender;
...
.method public constructor <init>(Lo/writeStringNoTag;Lo/DataTransportCrashlyticsReportSender;Lo/CachedSettingsIo;)V
    ...
    .line 39
    iput-object p1, p0, Lo/performItemClick;->onNavigationEvent:Lo/writeStringNoTag;

    .line 40
    iput-object p2, p0, Lo/performItemClick;->onPostMessage:Lo/DataTransportCrashlyticsReportSender;

    .line 41
    iput-object p3, p0, Lo/performItemClick;->extraCallback:Lo/CachedSettingsIo;
...
.method public final read(Lo/checkNoSpaceLeft;)Ljava/lang/Object;
    ...
    :cond_0
    new-instance v0, Lcom/cred/pay/repository/models/VpaAccount;

    invoke-direct {v0}, Lcom/cred/pay/repository/models/VpaAccount;-><init>()V

    iget-object v1, p0, Lo/performItemClick;->onNavigationEvent:Lo/writeStringNoTag;

    iget-object v3, p0, Lo/performItemClick;->onPostMessage:Lo/DataTransportCrashlyticsReportSender;
    ...
    check-cast v4, Lcom/cred/pay/repository/models/Account;

    iput-object v4, v0, Lcom/cred/pay/repository/models/VpaAccount;->extraCallback:Lcom/cred/pay/repository/models/Account;

    goto :goto_0

    :cond_3
    iput-object v2, v0, Lcom/cred/pay/repository/models/VpaAccount;->extraCallback:Lcom/cred/pay/repository/models/Account;
    ...
    iput-object v4, v0, Lcom/cred/pay/repository/models/VpaAccount;->onPostMessage:Ljava/lang/String;

    goto :goto_0

    :cond_5
    iput-object v2, v0, Lcom/cred/pay/repository/models/VpaAccount;->onPostMessage:Ljava/lang/String;
...
.method public final write(Lo/computeTagSize;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lo/performItemClick;->onNavigationEvent:Lo/writeStringNoTag;

    iget-object v1, p0, Lo/performItemClick;->extraCallback:Lo/CachedSettingsIo;

    .line 1000
    invoke-virtual {p1}, Lo/computeTagSize;->onNavigationEvent()Lo/computeTagSize;

    .line 2000
    iget-object v2, p2, Lcom/cred/pay/repository/models/VpaAccount;->extraCallback:Lcom/cred/pay/repository/models/Account;
    ...
    iget-object v3, p2, Lcom/cred/pay/repository/models/VpaAccount;->extraCallback:Lcom/cred/pay/repository/models/Account;
