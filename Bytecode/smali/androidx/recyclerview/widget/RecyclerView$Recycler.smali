...
.method private attachAccessibilityDelegateOnBind(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;->getItemDelegate()Lo/onSessionDestroyed;
    ...
    .line 6316
    :cond_2
    invoke-static {p1, v0}, Lo/unregisterCallbackListener;->onMessageChannelReady(Landroid/view/View;Lo/onSessionDestroyed;)V
...
.method public final addViewHolderToRecycledViewPool(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Z)V
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;->getItemDelegate()Lo/onSessionDestroyed;
    ...
    .line 6532
    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate$ItemDelegate;->getAndRemoveOriginalDelegateForItem(Landroid/view/View;)Lo/onSessionDestroyed;
...
.method public final bindViewToPosition(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p2}, Lo/onSkipToNext;->onMessageChannelReady(I)I
...
.method public final convertPreLayoutPositionToPostLayout(I)I
    ...
    invoke-virtual {v0, p1}, Lo/onSkipToNext;->onMessageChannelReady(I)I
...
.method final getChangedScrapViewForPosition(I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lo/onSkipToNext;

    .line 7468
    invoke-virtual {v3, p1, v2}, Lo/onSkipToNext;->onNavigationEvent(II)I
...
.method final getScrapOrHiddenOrCachedHolderForPosition(IZ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Lo/onRewind;

    .line 8206
    iget-object v3, v2, Lo/onRewind;->onPostMessage:Ljava/util/List;
    ...
    .line 8208
    iget-object v5, v2, Lo/onRewind;->onPostMessage:Ljava/util/List;
    ...
    .line 8209
    iget-object v6, v2, Lo/onRewind;->extraCallback:Lo/onRewind$onNavigationEvent;

    invoke-interface {v6, v5}, Lo/onRewind$onNavigationEvent;->onMessageChannelReady(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Lo/onRewind;

    .line 8350
    iget-object v0, p2, Lo/onRewind;->extraCallback:Lo/onRewind$onNavigationEvent;

    invoke-interface {v0, v5}, Lo/onRewind$onNavigationEvent;->onNavigationEvent(Landroid/view/View;)I
    ...
    .line 8354
    iget-object v1, p2, Lo/onRewind;->ICustomTabsCallback:Lo/onRewind$onPostMessage;

    invoke-virtual {v1, v0}, Lo/onRewind$onPostMessage;->extraCallback(I)Z
    ...
    invoke-virtual {v1, v0}, Lo/onRewind$onPostMessage;->onPostMessage(I)V

    .line 9070
    iget-object v0, p2, Lo/onRewind;->onPostMessage:Ljava/util/List;
    ...
    invoke-interface {p2, v5}, Lo/onRewind$onNavigationEvent;->onPostMessage(Landroid/view/View;)V
    ...
    invoke-virtual {p2, v5}, Lo/onRewind;->onNavigationEvent(Landroid/view/View;)I
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Lo/onRewind;

    invoke-virtual {v0, p2}, Lo/onRewind;->onNavigationEvent(I)V
...
.method final recycleAndClearCachedViews()V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Lo/onSetCaptioningEnabled$ICustomTabsCallback;

    .line 7152
    iget-object v1, v0, Lo/onSetCaptioningEnabled$ICustomTabsCallback;->onNavigationEvent:[I
    ...
    .line 7155
    iput v1, v0, Lo/onSetCaptioningEnabled$ICustomTabsCallback;->onPostMessage:I
...
.method final recycleViewHolderInternal(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v4, v4, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Lo/onSetCaptioningEnabled$ICustomTabsCallback;

    iget v5, p1, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPosition:I

    .line 6475
    invoke-virtual {v4, v5}, Lo/onSetCaptioningEnabled$ICustomTabsCallback;->extraCallback(I)Z
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Lo/onSetCaptioningEnabled$ICustomTabsCallback;

    invoke-virtual {v5, v4}, Lo/onSetCaptioningEnabled$ICustomTabsCallback;->extraCallback(I)Z
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Lo/onCustomAction;

    invoke-virtual {v3, p1}, Lo/onCustomAction;->onNavigationEvent(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public final tryGetViewHolderForPositionByDeadline(IZJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    .locals 16
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lo/onSkipToNext;

    invoke-virtual {v5, v3}, Lo/onSkipToNext;->onMessageChannelReady(I)I
    ...
    invoke-virtual {v0, v3}, Lo/onSkipToNext;->onMessageChannelReady(I)I
