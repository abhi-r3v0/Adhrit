.class public final Lo/ExpandableTransformationBehavior;
...
.method static onPostMessage(Lo/setPasswordVisibilityToggleContentDescription;Landroid/os/Parcel;I)V
    .locals 5
    ...
    invoke-virtual {p0}, Lo/setPasswordVisibilityToggleContentDescription;->extraCallback()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lo/setPasswordVisibilityToggleContentDescription;->onMessageChannelReady()Lcom/google/android/gms/common/data/DataHolder;
    ...
    invoke-virtual {p0}, Lo/setPasswordVisibilityToggleContentDescription;->onNavigationEvent()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {p0}, Lo/setPasswordVisibilityToggleContentDescription;->ICustomTabsCallback()J

    move-result-wide v3

    const/4 p2, 0x5

    invoke-static {p1, p2, v3, v4}, Lo/extraCallback;->onMessageChannelReady(Landroid/os/Parcel;IJ)V

    invoke-virtual {p0}, Lo/setPasswordVisibilityToggleContentDescription;->onPostMessage()[B

    move-result-object p0

    const/4 p2, 0x6

    invoke-static {p1, p2, p0, v2}, Lo/extraCallback;->ICustomTabsCallback(Landroid/os/Parcel;I[BZ)V
...
.method public final synthetic createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    new-instance p1, Lo/setPasswordVisibilityToggleContentDescription;

    move-object v4, p1

    invoke-direct/range {v4 .. v10}, Lo/setPasswordVisibilityToggleContentDescription;-><init>(Ljava/lang/String;Lcom/google/android/gms/common/data/DataHolder;Landroid/os/ParcelFileDescriptor;J[B)V
...
.method public final synthetic newArray(I)[Ljava/lang/Object;
    ...
    new-array p1, p1, [Lo/setPasswordVisibilityToggleContentDescription;
