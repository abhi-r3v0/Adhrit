.class public final Lo/messageForException;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lo/cacheTrackedQuery;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-static {v1}, Lo/messageForException;->onNavigationEvent(Landroid/os/Looper;)Landroid/os/Handler;

    move-result-object v1

    const-string v2, "Main"

    invoke-direct {v0, v1, v2}, Lo/cacheTrackedQuery;-><init>(Landroid/os/Handler;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {v0}, Lo/emptyWrite;->onMessageChannelReady(Ljava/lang/Object;)Z

    return-void
.end method

.method public static final onNavigationEvent(Landroid/os/Looper;)Landroid/os/Handler;
    .locals 8
