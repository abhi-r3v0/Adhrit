.class public final Lo/getCurrentSessionId;
...
# instance fields
.field private final zza:Lo/putInt;
...
.method public constructor <init>(Ljava/lang/String;Lo/calculateFreeRamInBytes;)V
    ...
    .line 3
    new-instance v0, Lo/putInt;

    invoke-direct {v0, p1, p2}, Lo/putInt;-><init>(Ljava/lang/String;Lo/calculateFreeRamInBytes;)V

    iput-object v0, p0, Lo/getCurrentSessionId;->zza:Lo/putInt;
...
.method public final synthetic zza(Lo/finalizePreviousNativeSession;Lo/removeBackgroundStateChangeListener;)V
    ...
    iget-object p2, p0, Lo/getCurrentSessionId;->zza:Lo/putInt;

    .line 23
    invoke-virtual {p2}, Lo/putInt;->onMessageChannelReady()Ljava/lang/String;

    move-result-object p2

    iget-object v0, p0, Lo/getCurrentSessionId;->zza:Lo/putInt;

    .line 24
    invoke-virtual {v0}, Lo/putInt;->onNavigationEvent()Lo/calculateFreeRamInBytes;
    ...
    .line 25
    invoke-interface {p1, p2, v0, v1}, Lo/doWriteNonFatal;->zzb(Ljava/lang/String;Lo/calculateFreeRamInBytes;Lo/getCurrentTimestampSeconds;)V
    ...
    .line 28
    invoke-interface {p1, p2, v0}, Lo/doWriteNonFatal;->zza(Lo/putInt;Lo/getCurrentTimestampSeconds;)V
...
.method public final zzb()Lo/isFabrikEnabled;
    ...
    .line 11
    new-instance v1, Lo/onGetChildDrawingOrder$getDefaultImpl$extraCallback;

    invoke-direct {v1, p0}, Lo/onGetChildDrawingOrder$getDefaultImpl$extraCallback;-><init>(Lo/getCurrentSessionId;)V
