...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/appcompat/widget/ActivityChooserView$extraCallback;,
        Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;
    }
.end annotation
...
.field final mAdapter:Landroidx/appcompat/widget/ActivityChooserView$extraCallback;

.field private final mCallbacks:Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;
...
.field mProvider:Lo/IMediaControllerCallback;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 224
    sget-object v1, Lo/extraCallback$asInterface;->ActivityChooserView:[I
    ...
    .line 226
    sget-object v5, Lo/extraCallback$asInterface;->ActivityChooserView:[I
    ...
    .line 229
    sget p2, Lo/extraCallback$asInterface;->ActivityChooserView_initialActivityCount:I
    ...
    .line 233
    sget p2, Lo/extraCallback$asInterface;->ActivityChooserView_expandActivityOverflowButtonDrawable:I
    ...
    .line 239
    sget v0, Lo/extraCallback$ICustomTabsCallback$Stub;->abc_activity_chooser_view:I
    ...
    .line 241
    new-instance p3, Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;

    invoke-direct {p3, p0}, Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object p3, p0, Landroidx/appcompat/widget/ActivityChooserView;->mCallbacks:Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;

    .line 243
    sget p3, Lo/extraCallback$asBinder;->activity_chooser_view_content:I
    ...
    .line 246
    sget p3, Lo/extraCallback$asBinder;->default_activity_button:I
    ...
    .line 247
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mCallbacks:Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;
    ...
    sget v0, Lo/extraCallback$asBinder;->image:I
    ...
    .line 251
    sget p3, Lo/extraCallback$asBinder;->expand_activities_button:I
    ...
    invoke-direct {v0, p0, p3}, Landroidx/appcompat/widget/ActivityChooserView$1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    .line 283
    new-instance p2, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/ActivityChooserView$extraCallback;

    .line 284
    new-instance p3, Landroidx/appcompat/widget/ActivityChooserView$4;

    invoke-direct {p3, p0}, Landroidx/appcompat/widget/ActivityChooserView$4;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V
...
.method public getDataModel()Landroidx/appcompat/widget/ActivityChooserModel;
    ...
    .line 482
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/ActivityChooserView$extraCallback;
...
.method getListPopupWindow()Landroidx/appcompat/widget/ListPopupWindow;
    ...
    .line 528
    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/ActivityChooserView$extraCallback;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mCallbacks:Landroidx/appcompat/widget/ActivityChooserView$onPostMessage;
...
.method public setActivityChooserModel(Landroidx/appcompat/widget/ActivityChooserModel;)V
    ...
    .line 1692
    iget-object v1, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback$Stub:Landroidx/appcompat/widget/ActivityChooserView;

    iget-object v1, v1, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/ActivityChooserView$extraCallback;

    .line 1841
    iget-object v1, v1, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onNavigationEvent:Landroidx/appcompat/widget/ActivityChooserModel;

    if-eqz v1, :cond_0

    .line 1693
    iget-object v2, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback$Stub:Landroidx/appcompat/widget/ActivityChooserView;
    ...
    iget-object v2, v2, Landroidx/appcompat/widget/ActivityChooserView;->mModelDataSetObserver:Landroid/database/DataSetObserver;

    invoke-virtual {v1, v2}, Landroid/database/Observable;->unregisterObserver(Ljava/lang/Object;)V

    .line 1696
    :cond_0
    iput-object p1, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onNavigationEvent:Landroidx/appcompat/widget/ActivityChooserModel;
...
.method public setProvider(Lo/IMediaControllerCallback;)V
    .locals 0

    .line 345
    iput-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mProvider:Lo/IMediaControllerCallback;
...
.method showPopupUnchecked(I)V
    ...
    .line 377
    :goto_0
    iget-object v3, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/ActivityChooserView$extraCallback;

    .line 3833
    iget-object v3, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onNavigationEvent:Landroidx/appcompat/widget/ActivityChooserModel;

    invoke-virtual {v3}, Landroidx/appcompat/widget/ActivityChooserModel;->onPostMessage()I
    ...
    .line 4826
    iget-boolean v4, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onPostMessage:Z

    if-eq v4, v2, :cond_1

    .line 4827
    iput-boolean v2, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onPostMessage:Z
    ...
    .line 5815
    iget v4, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onMessageChannelReady:I

    if-eq v4, p1, :cond_4

    .line 5816
    iput p1, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onMessageChannelReady:I
    ...
    .line 5827
    iput-boolean v1, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->onPostMessage:Z
    ...
    .line 7846
    iget-boolean v3, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->extraCallback:Z

    if-nez v3, :cond_6

    iget-boolean v3, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback:Z

    if-eqz v3, :cond_9

    .line 7848
    :cond_6
    iput-boolean v1, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->extraCallback:Z

    .line 7849
    iput-boolean v1, v0, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback:Z
    ...
    .line 6846
    iget-boolean v4, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->extraCallback:Z

    if-ne v4, v2, :cond_8

    iget-boolean v4, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback:Z

    if-eq v4, v0, :cond_9

    .line 6848
    :cond_8
    iput-boolean v2, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->extraCallback:Z

    .line 6849
    iput-boolean v0, v3, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback:Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->ICustomTabsCallback()I
    ...
    .line 398
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mProvider:Lo/IMediaControllerCallback;

    if-eqz v0, :cond_a

    .line 399
    invoke-virtual {v0, v2}, Lo/IMediaControllerCallback;->subUiVisibilityChanged(Z)V
    ...
    sget v3, Lo/extraCallback$onRelationshipValidationResult;->abc_activitychooserview_choose_application:I
...
.method updateAppearance()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$extraCallback;->getCount()I
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/ActivityChooserModel;->onNavigationEvent()I
