.class abstract Lo/getContactUsViewTitle;
...
.method static onPostMessage(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
    .locals 7
    ...
    :goto_3
    :try_start_6
    new-instance v3, Lo/showContactUsOnFaqNotHelpful;

    invoke-direct {v3, v2, v0}, Lo/showContactUsOnFaqNotHelpful;-><init>(II)V
...
# virtual methods
.method abstract ICustomTabsCallback(I[BII)I
.end method

.method abstract ICustomTabsCallback(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
.end method

.method abstract extraCallback(Ljava/lang/CharSequence;[BII)I
.end method
...
.method final onMessageChannelReady([BII)Z
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Lo/getContactUsViewTitle;->ICustomTabsCallback(I[BII)I
