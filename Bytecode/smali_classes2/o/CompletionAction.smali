.class public final Lo/CompletionAction;
.super Lo/Color;
...
.method public final ICustomTabsService$Stub$Proxy()Lo/credProtectDeactivated;
    ...
    instance-of v3, v2, Lo/credProtectDeactivated;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lo/credProtectDeactivated;

    goto :goto_0

    :cond_1
    new-instance v2, Lo/isCalendarReminderEnabled;

    invoke-direct {v2, v1}, Lo/isCalendarReminderEnabled;-><init>(Landroid/os/IBinder;)V
...
.method public final onMessageChannelReady()Lo/enableDarkMode;
    ...
    check-cast v1, Lo/enableDarkMode;
