...
.method synthetic constructor <init>(Lo/doBestEffortWrite;)V
    ...
    .line 25
    invoke-direct {p0}, Lo/getApi;-><init>()V

    return-void
.end method

.method private static onPostMessage(Ljava/lang/Object;J)Lo/UserRecoverableException;
    .locals 0
    ...
    check-cast p0, Lo/UserRecoverableException;
...
.method final ICustomTabsCallback(Ljava/lang/Object;J)V
    ...
    .line 10
    invoke-static {p1, p2, p3}, Lo/getApi;->onPostMessage(Ljava/lang/Object;J)Lo/UserRecoverableException;

    move-result-object p1

    .line 11
    invoke-interface {p1}, Lo/UserRecoverableException;->ICustomTabsCallback()V
...
.method final ICustomTabsCallback(Ljava/lang/Object;Ljava/lang/Object;J)V
    ...
    .line 13
    invoke-static {p1, p3, p4}, Lo/getApi;->onPostMessage(Ljava/lang/Object;J)Lo/UserRecoverableException;

    move-result-object v0

    .line 14
    invoke-static {p2, p3, p4}, Lo/getApi;->onPostMessage(Ljava/lang/Object;J)Lo/UserRecoverableException;
    ...
    .line 16
    invoke-interface {p2}, Lo/UserRecoverableException;->size()I
    ...
    .line 19
    invoke-interface {v0, v2}, Lo/UserRecoverableException;->extraCallback(I)Lo/UserRecoverableException;

    move-result-object v0

    .line 20
    :cond_0
    invoke-interface {v0, p2}, Lo/UserRecoverableException;->addAll(Ljava/util/Collection;)Z
