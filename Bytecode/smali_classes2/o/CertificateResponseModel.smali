.class public final Lo/CertificateResponseModel;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lo/MachinePullInternalFragment$onViewCreated$4$2$$special$$inlined$executeOnResume$1;->ICustomTabsCallback:[[B

    iput-object v0, p0, Lo/CertificateResponseModel;->extraCallback:[[B

    const/4 v0, 0x0

    iput-object v0, p0, Lo/CertificateResponseModel;->ICustomTabsCallback:[B

    const/4 v0, -0x1

    iput v0, p0, Lo/CertificateResponseModel;->subscribe:I

    return-void
.end method

.method private final onPostMessage(Lo/TemplateDataJsonAdapter;)Lo/CertificateResponseModel;
    .locals 5
    ...
    invoke-static {v2}, Lo/ListPoints;->onNavigationEvent(I)I
    ...
    iput-object v2, p0, Lo/CertificateResponseModel;->onPostMessage:Ljava/lang/Integer;
    :try_end_0
    ...
    invoke-static {v2}, Lo/ListPoints;->extraCallback(I)I
    ...
    iput-object v2, p0, Lo/CertificateResponseModel;->onNavigationEvent:Ljava/lang/Integer;
    :try_end_1
    ...
    iget-object v1, p0, Lo/CertificateResponseModel;->extraCallback:[[B
    ...
    iget-object v4, p0, Lo/CertificateResponseModel;->extraCallback:[[B
    ...
    iput-object v3, p0, Lo/CertificateResponseModel;->extraCallback:[[B
...
.method protected final extraCallback()I
    ...
    invoke-static {v4}, Lo/AadharSingleSimSelector$onActivityResult$$inlined$executeOnResume$1;->onMessageChannelReady([B)I
    ...
    :cond_2
    iget-object v1, p0, Lo/CertificateResponseModel;->ICustomTabsCallback:[B
    ...
    :cond_3
    iget-object v1, p0, Lo/CertificateResponseModel;->onNavigationEvent:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v1, p0, Lo/CertificateResponseModel;->onPostMessage:Ljava/lang/Integer;
...
.method public final synthetic onNavigationEvent(Lo/TemplateDataJsonAdapter;)Lo/ClaimedRewardDetailsFragment$realDismiss$$inlined$executeOnResume$1;
    ...
    invoke-direct {p0, p1}, Lo/CertificateResponseModel;->onPostMessage(Lo/TemplateDataJsonAdapter;)Lo/CertificateResponseModel;
...
.method public final onPostMessage(Lo/AadharSingleSimSelector$onActivityResult$$inlined$executeOnResume$1;)V
    ...
    iget-object v0, p0, Lo/CertificateResponseModel;->extraCallback:[[B
    ...
    invoke-virtual {p1, v2, v1}, Lo/AadharSingleSimSelector$onActivityResult$$inlined$executeOnResume$1;->extraCallback(I[B)V
    ...
    :cond_1
    iget-object v0, p0, Lo/CertificateResponseModel;->ICustomTabsCallback:[B
    ...
    :cond_2
    iget-object v0, p0, Lo/CertificateResponseModel;->onNavigationEvent:Ljava/lang/Integer;
    ...
    :cond_3
    iget-object v0, p0, Lo/CertificateResponseModel;->onPostMessage:Ljava/lang/Integer;
