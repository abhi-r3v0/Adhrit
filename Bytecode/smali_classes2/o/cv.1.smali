...
.method constructor <init>(Lo/getCsatResponse$onPostMessage;Landroid/app/Activity;)V
    ...
    .line 1
    iput-object p1, p0, Lo/cv;->extraCallback:Lo/getCsatResponse$onPostMessage;

    iput-object p2, p0, Lo/cv;->onPostMessage:Landroid/app/Activity;
...
.method final onMessageChannelReady()V
    ...
    .line 2
    iget-object v0, p0, Lo/cv;->extraCallback:Lo/getCsatResponse$onPostMessage;
    ...
    iget-object v1, p0, Lo/cv;->onPostMessage:Landroid/app/Activity;

    invoke-static {v1}, Lo/GetRatingResponseJsonAdapter;->ICustomTabsCallback(Ljava/lang/Object;)Lo/getEventName;

    move-result-object v1

    iget-wide v2, p0, Lo/cv;->onMessageChannelReady:J

    invoke-interface {v0, v1, v2, v3}, Lo/setControllerHideOnTouch;->onActivityPaused(Lo/getEventName;J)V
