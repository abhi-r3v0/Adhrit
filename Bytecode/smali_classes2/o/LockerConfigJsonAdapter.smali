.class final Lo/LockerConfigJsonAdapter;
...
.field private final synthetic onNavigationEvent:Lo/BankAccountData;
...
.method constructor <init>(Lo/LiveCounter;Landroid/content/Context;Lo/setCurrentItem$default;Ljava/lang/String;Lo/BankAccountData;)V
    ...
    iput-object p1, p0, Lo/LockerConfigJsonAdapter;->extraCallback:Lo/LiveCounter;

    iput-object p2, p0, Lo/LockerConfigJsonAdapter;->onPostMessage:Landroid/content/Context;

    iput-object p3, p0, Lo/LockerConfigJsonAdapter;->ICustomTabsCallback:Lo/setCurrentItem$default;

    iput-object p4, p0, Lo/LockerConfigJsonAdapter;->onMessageChannelReady:Ljava/lang/String;

    iput-object p5, p0, Lo/LockerConfigJsonAdapter;->onNavigationEvent:Lo/BankAccountData;
...
.method public final synthetic ICustomTabsCallback()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lo/LockerConfigJsonAdapter;->extraCallback:Lo/LiveCounter;
    ...
    iget-object v2, p0, Lo/LockerConfigJsonAdapter;->onPostMessage:Landroid/content/Context;

    iget-object v3, p0, Lo/LockerConfigJsonAdapter;->ICustomTabsCallback:Lo/setCurrentItem$default;

    iget-object v4, p0, Lo/LockerConfigJsonAdapter;->onMessageChannelReady:Ljava/lang/String;

    iget-object v5, p0, Lo/LockerConfigJsonAdapter;->onNavigationEvent:Lo/BankAccountData;
    ...
    iget-object v1, p0, Lo/LockerConfigJsonAdapter;->onPostMessage:Landroid/content/Context;
...
.method public final synthetic ICustomTabsCallback(Lo/StatisticsItem;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lo/LockerConfigJsonAdapter;->onPostMessage:Landroid/content/Context;
    ...
    invoke-interface/range {v1 .. v6}, Lo/StatisticsItem;->createInterstitialAdManager(Lo/getEventName;Lo/setCurrentItem$default;Ljava/lang/String;Lo/BankAccountData;I)Lo/SpinDetail;
