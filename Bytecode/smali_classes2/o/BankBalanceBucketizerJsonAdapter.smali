.class public final Lo/BankBalanceBucketizerJsonAdapter;
.super Lo/Color;
...
.method public final ICustomTabsCallback$Stub()Lo/RawBankAccountJsonAdapter;
    ...
    instance-of v3, v2, Lo/RawBankAccountJsonAdapter;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lo/RawBankAccountJsonAdapter;

    goto :goto_0

    :cond_1
    new-instance v2, Lo/SectionData;

    invoke-direct {v2, v1}, Lo/SectionData;-><init>(Landroid/os/IBinder;)V
...
.method public final asInterface()Lo/TrackBalanceConfigsJsonAdapter;
    ...
    instance-of v3, v2, Lo/TrackBalanceConfigsJsonAdapter;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lo/TrackBalanceConfigsJsonAdapter;

    goto :goto_0

    :cond_1
    new-instance v2, Lo/AlarmResponse;

    invoke-direct {v2, v1}, Lo/AlarmResponse;-><init>(Landroid/os/IBinder;)V
...
.method public final extraCallback(Lo/getEventName;Lo/setLastItem;Ljava/lang/String;Ljava/lang/String;Lo/PromotionalCardsJsonAdapter;Lo/activateCredProtect;Ljava/util/List;)V
    ...
    invoke-static {v0, p6}, Lo/ClaimedSectionsResponseJsonAdapter;->onPostMessage(Landroid/os/Parcel;Landroid/os/Parcelable;)V
...
.method public final newSession()Lo/openGameRewards;
    ...
    invoke-static {v1}, Lo/FabrikWebViewFragment$MyJavascriptInterface$logout$$inlined$executeOnResume$1;->extraCallback(Landroid/os/IBinder;)Lo/openGameRewards;
...
.method public final updateVisuals()Lo/LiveCallbackWrapper;
    ...
    instance-of v3, v2, Lo/LiveCallbackWrapper;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lo/LiveCallbackWrapper;

    goto :goto_0

    :cond_1
    new-instance v2, Lo/StringEntity;

    invoke-direct {v2, v1}, Lo/StringEntity;-><init>(Landroid/os/IBinder;)V
