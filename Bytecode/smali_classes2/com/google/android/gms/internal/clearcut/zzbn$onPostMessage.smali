.class final Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;
...
.method constructor <init>(Ljava/nio/ByteBuffer;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onMessageChannelReady:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onNavigationEvent:Ljava/nio/ByteBuffer;

    invoke-static {p1}, Lo/shouldShowContactUsOnFaqScreens;->onNavigationEvent(Ljava/nio/ByteBuffer;)J

    move-result-wide v0

    iput-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->extraCallback:J
    ...
    iput-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onPostMessage:J

    iget-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->extraCallback:J
    ...
    iput-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->asInterface:J

    const-wide/16 v2, 0xa

    sub-long/2addr v0, v2

    iput-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->asBinder:J

    iget-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onPostMessage:J

    iput-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
...
.method private final onRelationshipValidationResult(J)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onNavigationEvent:Ljava/nio/ByteBuffer;

    iget-wide v1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->extraCallback:J
...
.method public final ICustomTabsCallback(J)V
    ...
    iget-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J

    iget-wide v2, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->asBinder:J
    ...
    iput-wide v9, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J

    long-to-int p2, p1

    int-to-byte p1, p2

    invoke-static {v0, v1, p1}, Lo/shouldShowContactUsOnFaqScreens;->ICustomTabsCallback(JB)V
    ...
    iput-wide v2, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
    ...
    invoke-static {v0, v1, v2}, Lo/shouldShowContactUsOnFaqScreens;->ICustomTabsCallback(JB)V
    ...
    iget-wide v2, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->asInterface:J
    ...
    iget-wide v1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
    ...
    iget-wide v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->asInterface:J
...
.method public final extraCallback()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onMessageChannelReady:Ljava/nio/ByteBuffer;

    iget-wide v1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J

    iget-wide v3, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->extraCallback:J
...
.method public final onMessageChannelReady()I
    ...
    iget-wide v2, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
...
.method public final onMessageChannelReady(J)V
    ...
    iget-wide p1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J

    const-wide/16 v0, 0x8

    add-long/2addr p1, v0

    iput-wide p1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
...
.method public final onMessageChannelReady([BII)V
    ...
    iget-wide v5, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
    ...
    invoke-static/range {v2 .. v8}, Lo/shouldShowContactUsOnFaqScreens;->onPostMessage([BJJJ)V
    ...
    iget-wide v1, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->asInterface:J
...
.method public final onNavigationEvent(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact(I)I
    ...
    invoke-static {v3}, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact(I)I

    move-result v3

    if-ne v3, v2, :cond_0

    iget-wide v4, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J

    iget-wide v6, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->extraCallback:J
    ...
    iget-object v3, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onNavigationEvent:Ljava/nio/ByteBuffer;

    invoke-virtual {v3, v2}, Ljava/nio/ByteBuffer;->position(I)Ljava/nio/Buffer;

    iget-object v3, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onNavigationEvent:Ljava/nio/ByteBuffer;

    invoke-static {p1, v3}, Lo/shouldShowContactUsOnAppBar;->onNavigationEvent(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
    ...
    iput-wide v4, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/gms/internal/clearcut/zzbn;->onPostMessage(I)V

    iget-wide v3, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J

    invoke-direct {p0, v3, v4}, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onRelationshipValidationResult(J)V
    ...
    iput-wide v3, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onTransact:J
    :try_end_0
    .catch Lo/showContactUsOnFaqNotHelpful; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->onRelationshipValidationResult(J)V

    invoke-virtual {p0, p1, v2}, Lcom/google/android/gms/internal/clearcut/zzbn;->onMessageChannelReady(Ljava/lang/String;Lo/showContactUsOnFaqNotHelpful;)V
...
.method final onPostMessage(Lo/NativeBlurFilter;Lo/nativeAddRoundedCornersFilter;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/clearcut/zzbn$onPostMessage;->ICustomTabsCallback:Lo/nativeDispose;
